...
const SKILLS = [
  ...
  {
    name: "Tailwind CSS",
    svg: "https://cdn.simpleicons.org/tailwindcss/f97316",
  },
  ...
  {
    name: "VS Code",
    svg: "https://cdn.simpleicons.org/visualstudiocode/f97316",
  },
...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "This very portfolio — a production-grade, fully responsive React application with Framer Motion animations, dark theme, multi-section navigation, contact form, and separate Data & Dev sub-portfolios.",
    url: "https://github.com/ShivGupta12234",
    liveUrl: "https://mydataapplied.vercel.app/",
  ...
  },
  {
    ...
    description:
      "A full-stack trading analytics platform that loads, cleans, and transforms financial data, delivering interactive visualisations and insights through a modern, responsive web interface.",
...
const CODING_PROFILES = [
  {
    ...
    description:
      "Solving DSA problems with optimal solutions — focused on runtime efficiency and algorithmic thinking.",
    stats: [
      { label: "Solved", value: "50+" },
      { label: "Focus", value: "DSA" },
      { label: "Lang", value: "C++/Python" },
    ],
    Logo: LeetCodeSVG,
  ...
  },
  {
    ...
    url: "https://github.com/ShivGupta12234",
    description:
      "Full-stack projects, React apps, REST APIs and data pipelines — all versioned, documented, and open.",
    stats: [
      { label: "Repos", value: "10+" },
      { label: "Focus", value: "Web+Data" },
      { label: "Lang", value: "JS/Python" },
    ],
    Logo: GitHubSVG,
  ...
  },
  {
    ...
    description:
      "Practising SQL, Python and problem solving challenges — earning domain badges consistently.",
    stats: [
      { label: "Badge", value: "5★ SQL" },
      { label: "Focus", value: "SQL/Python" },
      { label: "Domain", value: "Dev" },
    ],
    Logo: HackerRankSVG,
  ...
  },
  {
    ...
    description:
      "Practising SQL interview questions used at top tech companies to sharpen real-world query skills.",
    stats: [
      { label: "Focus", value: "SQL" },
      { label: "Platform", value: "DataLemur" },
      { label: "Goal", value: "Dev Roles" },
    ],
    Logo: DataLemurSVG,
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 relative z-10">
        ...
        <div className="flex flex-col items-end gap-2 flex-shrink-0">
          ...
          <motion.span
            className={`text-base ${project.accentColor} opacity-0 group-hover:opacity-100 transition-all duration-300`}
            animate={{ x: [0, 4, 0] }}
...
function DevLoader({ onDone }) {
  ...
  useEffect(() => {
    ...
    [100, 300].forEach((t) => {
      setTimeout(() => setGlitch(true), t);
      setTimeout(() => setGlitch(false), t + 80);
    });
    const prog = setInterval(() => {
      setProgress((p) => {
        ...
        return p + (p < 50 ? 1.6 : p < 80 ? 1.0 : 0.55);
      });
    }, 28);
    BOOT_LINES.forEach((line, i) => {
      setTimeout(
        () => {
          setLines((l) => [...l, line]);
          if (i === BOOT_LINES.length - 1) setPhase(2);
        },
        200 + i * 300,
      );
    });
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 w-full max-w-lg">
        ...
        >
          <div className="relative w-16 h-16 flex items-center justify-center">
            <motion.div
              animate={{ opacity: [1, 0.6, 1], x: [0, -1, 1, -1, 0] }}
              transition={{ duration: 0.12, repeat: 3, repeatDelay: 1.5 }}
            >
              <span
        ...
        <div className="w-full space-y-2">
          ...
          <div className="h-[3px] w-full bg-orange-500/10 rounded-full overflow-hidden">
            <motion.div
              className="h-full bg-gradient-to-r from-orange-700 via-orange-500 to-orange-300 rounded-full relative overflow-hidden"
              style={{ width: `${progress}%` }}
            >
              <motion.div
                className="absolute right-0 top-0 w-8 h-full bg-white/25 blur-sm"
      ...
      <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
              ...
              <div className="relative w-full max-w-[300px] sm:max-w-[380px] lg:max-w-[480px]">
                ...
                >
                  ...
                  {[
                    ...
                    {
                      y: 360,
                      text: "app.get('/api', (req, res) => {",
                      color: "white",
                      opacity: 0.5,
                    },
                    {
                      y: 374,
                      text: "  res.json({ status: 'live' });",
                      color: "#f97316",
                      opacity: 0.55,
                    },
                  ].map((line, i) => (
        ...
        <section id="skills" className="relative py-16 sm:py-24 z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
            <FadeIn>
              <SectionLabel comment="// tech stack & tools" title="Skills" />
            </FadeIn>
            <FadeIn delay={0.1}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
                {[
                  ...
                  { label: "Databases", items: "MySQL, MongoDB, PostgreSQL, SQLite" },
                  {
                    label: "Dev Tools",
                    items:
                      "Docker, Git, Vite, Figma, VS Code, Socket.io, CI/CD, JWT",
                  },
                ].map((cat) => (
                  <motion.div
                    key={cat.label}
              ...
              <FadeIn delay={0.1} className="lg:col-span-2">
                <div className="flex flex-col gap-6 h-full">
                  ...
                  >
                    ...
                    , freelance projects, or any meaningful collaboration.
                  </p>
                  {[
                    {
                      icon: "📧",
