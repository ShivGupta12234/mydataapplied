...
function GrainOverlay() {
  return (
    ...
    >
      ...
      <rect width="100%" height="100%" filter="url(#mda-grain-data)" />
    </svg>
  );
}
...
const SKILLS = [
  ...
  {
    name: "Scikit-Learn",
    svg: "https://cdn.simpleicons.org/scikitlearn/f97316",
  },
  ...
  { name: "PostgreSQL", svg: "https://cdn.simpleicons.org/postgresql/f97316" },
  {
    ...
    svg: "https://cdn.simpleicons.org/microsoftexcel/f97316",
  },
  {
    name: "Google Sheets",
    svg: "https://cdn.simpleicons.org/googlesheets/f97316",
  },
...
const CERTIFICATES = [
  ...
  },
  {
    ...
    pdfLink:
      "https://ninjasfiles.s3.amazonaws.com/certificate309928180d71dd61513e8358ba1649f0feafc92.pdf",
  ...
  },
  {
    ...
    pdfLink:
      "https://ninjasfiles.s3.amazonaws.com/certificate309928160f3c09a190ebf0c8850fb65cdce8fb6.pdf",
...
const CODING_PROFILES = [
  {
    ...
    description:
      "Solving data structure & algorithm problems with clean, optimal solutions. Focused on reducing runtime and sharpening problem-solving instincts.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Open-source projects, data analysis notebooks, dashboards and web apps. All code versioned and documented for collaboration.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Earning badges across SQL, Python and Problem Solving domains. Consistently practising real-world query challenges.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Practising SQL and data science interview questions used at top tech companies like Meta, Amazon, and Google.",
    stats: [
      ...
      {particles.map((p) => (
        <motion.div
          ...
          style={{
            ...
            height: p.size,
            boxShadow: p.bright
              ? `0 0 ${p.size * 4}px rgba(249,115,22,0.6)`
              : p.large
                ? `0 0 ${p.size * 2}px rgba(249,115,22,0.3)`
                : "none",
          }}
          animate={{
    ...
    >
      {skill.svg && !err ? (
        ...
        <span className="text-3xl leading-none">
          {skill.fallbackIcon || skill.name[0]}
        </span>
      )}
      <span
...
function CertCard({ cert, index }) {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute -top-4 -right-4 w-28 h-28 rounded-full bg-orange-500/10 blur-xl"
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 relative z-10">
        {profile.stats.map((stat) => (
          <div
            key={stat.label}
            className={`p-2.5 rounded-xl border ${profile.pillBorder} bg-black/25 text-center`}
          >
            <p
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`flex items-center gap-2 mb-5 px-4 py-2.5 rounded-xl border ${edu.borderColor} bg-black/20 relative z-10`}
        >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 relative z-10">
          <div
            className={`flex items-center gap-2 px-4 py-2 rounded-xl border ${edu.borderColor} bg-black/20`}
          >
    ...
    >
      ...
      <div className="flex flex-col gap-1.5 relative z-10">
        ...
        <motion.textarea
          ...
          value={form.message}
          onChange={handleChange}
          placeholder="Hi Shiv, I'd love to connect about..."
          required
          rows={5}
      ...
      <motion.button
        ...
        whileHover={
          status === "idle"
            ? { scale: 1.03, boxShadow: "0 0 30px rgba(249,115,22,0.4)" }
            : {}
        }
        whileTap={status === "idle" ? { scale: 0.97 } : {}}
        className={`group relative z-10 w-full py-4 font-bold tracking-widest uppercase text-sm rounded-xl overflow-hidden
...
function DataLoader({ onDone }) {
  ...
  useEffect(() => {
    ...
    const prog = setInterval(() => {
      setProgress((p) => {
        ...
        return p + (p < 60 ? 1.4 : p < 85 ? 0.8 : 0.5);
      });
    }, 28);
    LINES.forEach((line, i) => {
      setTimeout(
        () => {
          setRows((r) => [...r, line]);
          if (i === LINES.length - 1) setPhase(2);
        },
        280 + i * 320,
      );
    });
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute w-[500px] h-[500px] rounded-full bg-orange-500/14 blur-[130px] pointer-events-none"
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 w-full max-w-lg">
        ...
        >
          <div className="flex items-center gap-2 px-4 py-2.5 border-b border-orange-500/15 bg-orange-500/5">
            <div className="w-2.5 h-2.5 rounded-full bg-orange-500/90" />
            <div className="w-2.5 h-2.5 rounded-full bg-orange-500/45" />
      ...
      <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        <motion.nav
          ...
          className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-5 md:px-12 py-4 transition-all duration-300 ${
            scrolled
              ? "bg-black/95 backdrop-blur-md border-b border-orange-500/20 shadow-2xl shadow-orange-500/5"
              : "bg-transparent"
          }`}
        >
          ...
          <nav className="flex flex-col px-4 py-4 gap-1 flex-1">
            {NAV_LINKS.map((section, i) => (
              <motion.button
                ...
                initial={{ opacity: 0, x: 30 }}
                animate={
                  menuOpen ? { opacity: 1, x: 0 } : { opacity: 0, x: 30 }
                }
                transition={{
              ...
              >
                ...
                <motion.span
                  ...
                  animate={
                    activeSection === section ? { opacity: 1, x: 0 } : {}
                  }
          ...
          <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              >
                ...
                undergrad student focused on applied analytics, data cleaning,
                and insight-driven problem solving. I transform messy datasets
                into structured models and build clear, interactive dashboards
            ...
            >
              <div className="relative w-full max-w-[300px] sm:max-w-[380px] lg:max-w-[480px]">
                ...
                >
                  ...
                  {[
                    { x: 38, label: "Accuracy", value: "95.2%" },
                    { x: 183, label: "Records", value: "10K+" },
                    { x: 328, label: "Dashboards", value: "10+" },
                  ].map((kpi, i) => (
                    <motion.g
                      key={i}
                      initial={{ opacity: 0, y: 10 }}
                  ...
                  {[
                    { x: 24, y: 100, text: "Python" },
                    { x: 24, y: 123, text: "SQL" },
                    { x: 24, y: 146, text: "Power BI" },
                  ].map((tag, i) => (
                    <motion.g
                      key={i}
                      initial={{ opacity: 0 }}
        ...
        <section id="skills" className="relative py-16 sm:py-24 z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
            <FadeIn>
              <SectionLabel comment="// skills & tools" title="My Tech Stack" />
            </FadeIn>
            <FadeIn delay={0.1}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
                {[
                  ...
                  {
                    label: "BI & Sheets",
                    items: "Power BI, Tableau, Excel, Google Sheets",
                  },
                ].map((cat) => (
                  <motion.div
                    key={cat.label}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
            ...
            <FadeIn delay={0.15}>
              <div className="flex flex-col items-center justify-center py-28 border border-dashed border-orange-500/15 rounded-2xl">
                ...
                <p
                  className="text-orange-500 text-xl font-bold tracking-widest"
                  style={{ fontFamily: MONO }}
                >
                  Adding projects soon...
                </p>
                <p
                  className="text-gray-600 text-xs mt-3 tracking-widest"
                  style={{ fontFamily: MONO }}
                >
        ...
        <section id="coding" className="relative py-16 sm:py-24 z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-16 relative z-10">
            <FadeIn>
              <SectionLabel
                comment="// competitive programming & open source"
              ...
              <FadeIn delay={0.1} className="lg:col-span-2">
                <div className="flex flex-col gap-6 h-full">
                  ...
                  >
                    ...
                    , freelance projects, collaborations, or just a good
